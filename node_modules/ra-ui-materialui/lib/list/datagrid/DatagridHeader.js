 ...
 */
exports.DatagridHeader = function (props) {
    ...
    var _c = ra_core_1.useListContext(props), currentSort = _c.currentSort, data = _c.data, ids = _c.ids, onSelect = _c.onSelect, selectedIds = _c.selectedIds, setSort = _c.setSort;
    ...
    var selectableIds = isRowSelectable
        ...
        : ids;
    return (React.createElement(core_1.TableHead, { className: classnames_1.default(className, classes.thead) },
        React.createElement(core_1.TableRow, { className: classnames_1.default(classes.row, classes.headerRow) },
            hasExpand && (React.createElement(core_1.TableCell, { padding: "none", className: classnames_1.default(classes.headerCell, classes.expandHeader) })),
